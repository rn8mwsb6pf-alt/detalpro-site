    ...
    <>
      ...
      <main style={{ maxWidth: 900, margin: '0 auto', padding: '48px 24px' }}>
        ...
        <p style={{ color: 'var(--accent)', fontWeight: 600, marginBottom: 40, fontSize: 14 }}>
          ДЕТАЛЬПРО · На рынке с 2007 года
        </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32, marginBottom: 48 }}>
          <div>
            ...
            <p style={{ color: 'var(--text2)', lineHeight: 1.8, marginBottom: 12 }}>
              ДЕТАЛЬПРО — профессиональный интернет-магазин автозапчастей для легковых автомобилей и грузовой техники. Мы работаем с 2007 года и за это время помогли десяткам тысяч клиентов найти нужную деталь по выгодной цене.
            </p>
